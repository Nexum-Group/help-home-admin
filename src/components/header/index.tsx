        ...
        <header className="admin-header">
            ...
            <div className="admin-header-user">
                {pathName === '/admin/categories' && (
                    <>
                    <button onClick={() => setCreateOpen(true)} className="admin-btn admin-btn-primary">Nova categoria</button>
                    <button disabled onClick={() => setImportOpen(true)} className="admin-btn admin-btn-primary">Importar CSV</button>
                    </>
                )}
                <span>{data?.name}</span>
