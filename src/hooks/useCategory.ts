...
import { createCategory, getAllCategories, getCategory, updateCategory } from "../services/category.service"
...
export function useUpdateCategory() {
  return useMutation({
    mutationFn: ({ categoryUuid, data }: IUpdateCategoryParams) => updateCategory(data, categoryUuid),
  })
}
